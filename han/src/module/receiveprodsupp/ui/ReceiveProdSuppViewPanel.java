...
public class ReceiveProdSuppViewPanel extends JPanel implements Bridging {
	...
	private static final Logger LOGGER = Logger
			.getLogger(ReceiveProdSuppViewPanel.class);
	...
	List<RPSProduct> listOfRPSProduct = null;
	...
	ReceiveProdSuppViewPanel rprCreatePanel;
	...
	public ReceiveProdSuppViewPanel() {
		...
		btnEdit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MainPanel.changePanel("module.receiveprodsupp.ui.ReceiveProdSuppEditPanel", receiveProductSupp);
			}
		});
	...
	protected void doDelete() {
		try {
			ServiceFactory.getReceiveProductSuppBL().deleteAll(receiveProductSupp);
	...
	public void addProductSupp() {
		...
		btnInsertRPSProduct.setEnabled(false);
	...
	protected void doSave() {
		...
		try {
			ServiceFactory.getReceiveProductSuppBL().save(receiveProductSupp, listOfRPSProduct);
	...
	protected void showPPSDialog(
			ReceiveProdSuppViewPanel rprCreatePanel) {
//		PPSDialog ppsDialog = new PPSDialog(rprCreatePanel);
...
//		ppsDialog.setVisible(true);
	...
	protected void showCostCenterDialog(
			ReceiveProdSuppViewPanel rpsViewPanel) {
	}
	
	protected void showProductDialog(
			ReceiveProdSuppViewPanel rpsViewPanel) {
//		ProductDialog productDialog = new ProductDialog(rprCreatePanel);
...
//		productDialog.setVisible(true);
	...
	protected void showEditPPSProductDialog(PPSProduct pprProduct,
			ReceiveProdSuppViewPanel rpsViewPanel, Integer index) {
	}
