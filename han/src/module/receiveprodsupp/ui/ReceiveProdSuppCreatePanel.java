...
public class ReceiveProdSuppCreatePanel extends JPanel implements Bridging {
	...
	private static final Logger LOGGER = Logger
			.getLogger(ReceiveProdSuppCreatePanel.class);
	...
	ReceiveProdSuppCreatePanel rprCreatePanel;
	...
	public ReceiveProdSuppCreatePanel() {
	...
	public void addProductSupp() {
		...
		btnSearchProduct.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					showProductDialog(rprCreatePanel);
				}
	...
	protected void showCostCenterDialog(
			ReceiveProdSuppCreatePanel pprCreatePanel) {
	}
	...
	protected void showEditPPSProductDialog(PPSProduct pprProduct,
			ReceiveProdSuppCreatePanel pprCreatePanel, Integer index) {
	}
