...
public class PopUpBigViewMaterial extends JDialog{
	Logger log = LogManager.getLogger(PopUpBigViewMaterial.class.getName());
	...
	private ViewBigProductionPanel viewProductionPanel;
	private List<ProdRM> prodRms;

	private PopUpBigViewMaterial parentDialog;

	
	public PopUpBigViewMaterial(JPanel parent){
	...
	private void initData(JPanel parent){
		...
		parentDialog = this;
		viewProductionPanel = (ViewBigProductionPanel) parent;
