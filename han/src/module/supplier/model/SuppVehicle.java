...
public class SuppVehicle implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SuppVehicle other = (SuppVehicle) obj;
		if (deletedBy == null) {
	...
	public String toString() {
		return "Supplier(id=" + id + ",licensePlate=" + licensePlate + ",suppCode=" + suppCode + ",vehicleTypeId="
				+ vehicleTypeId + ",inputDate=" + inputDate + ",inputBy=" + inputBy + ",editDate=" + editDate
