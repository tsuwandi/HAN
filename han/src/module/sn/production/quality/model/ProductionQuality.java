package module.sn.production.quality.model;

import java.util.Date;

import module.util.ComboBoxProperties;

public class ProductionQuality implements ComboBoxProperties {
	private int id;
	...
	public int hashCode() {
		...
		result = prime * result + ((productionQuality == null) ? 0 : productionQuality.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProductionQuality other = (ProductionQuality) obj;
		if (deletedBy == null) {
		...
		if (productionQuality == null) {
			if (other.productionQuality != null)
				return false;
		} else if (!productionQuality.equals(other.productionQuality))
			return false;
		return true;
	}
	...
	public String toString() {
		return "ProductionQuality [id=" + id + ", productionQuality=" + productionQuality + ", inputDate=" + inputDate
	...
	public ProductionQuality() {
	}

	public ProductionQuality(String productionQuality) {
		this.productionQuality = productionQuality;
	}
