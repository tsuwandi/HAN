...
public class ProductionWasteEditPanel extends JPanel implements Bridging {
	...
	private static final Logger LOGGER = Logger.getLogger(ProductionWasteEditPanel.class);
	...
	public ProductionWasteEditPanel() {
	...
	protected void doSave() {
		...
		try {
			ServiceFactory.getProductionWasteBL().update(productionWaste, pwProductDetail(listOfPWProduct));
	...
	private List<PWProduct> pwProductDetail (List<PWProduct> listOfPWProductTemp) {
		for (PWProduct pwProduct : listOfPWProductTemp) {
			if (PRODUCT_CODE_KLEM_A.equals(pwProduct.getProductCode()))
				pwProduct.setQty(Integer.valueOf(txtRepairKlemTotalGradeA.getText()));
			else if (PRODUCT_CODE_KLEM_B.equals(pwProduct.getProductCode()))
				pwProduct.setQty(Integer.valueOf(txtRepairKlemTotalGradeB.getText()));
			else if (PRODUCT_CODE_PROTOL_A.equals(pwProduct.getProductCode()))
				pwProduct.setQty(Integer.valueOf(txtRepairProtolTotalGradeA.getText()));
			else if (PRODUCT_CODE_PROTOL_B.equals(pwProduct.getProductCode()))
				pwProduct.setQty(Integer.valueOf(txtRepairProtolTotalGradeB.getText()));
			else if (PRODUCT_CODE_NORMAL_A.equals(pwProduct.getProductCode()))
				pwProduct.setQty(Integer.valueOf(txtRepairNormalTotalGradeA.getText()));
			else if (PRODUCT_CODE_NORMAL_B.equals(pwProduct.getProductCode()))
				pwProduct.setQty(Integer.valueOf(txtRepairNormalTotalGradeB.getText()));
		}
