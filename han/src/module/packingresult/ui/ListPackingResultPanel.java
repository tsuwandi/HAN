...
//				pop.setLocationRelativeTo(null);
		...
		searchBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(!searchField.getText().equals("")){
					try {
						//TODO repair 
						List<Packing> packings = ServiceFactory.getPackingBL().getPackings(" AND type='9' AND status LIKE '%"+searchField.getText()+"%'");
	...
	public void setTableSize(){
		...
		TableColumn column12 = packingTable.getColumnModel().getColumn(12);
		TableColumn column13 = packingTable.getColumnModel().getColumn(13);
		TableColumn column14 = packingTable.getColumnModel().getColumn(14);
		TableColumn column15 = packingTable.getColumnModel().getColumn(15);
		...
		column11.setPreferredWidth(100);
		column11.setMinWidth(100);
		column11.setMaxWidth(100);

		column12.setPreferredWidth(100);
		column12.setMinWidth(100);
		column12.setMaxWidth(100);

		column13.setPreferredWidth(100);
		column13.setMinWidth(100);
		column13.setMaxWidth(100);

		column14.setPreferredWidth(100);
		column14.setMinWidth(100);
		column14.setMaxWidth(100);
		
		column15.setPreferredWidth(50);
		column15.setMinWidth(50);
		column15.setMaxWidth(50);
	...
	public class PackingTableModel extends AbstractTableModel implements Pagination{
	    ...
	    public Object getValueAt(int rowIndex, int columnIndex) {
	    	...
	    	double bigCrateC = 0;
	    	double smallCrateC = 0;
	    	double crateWasteA = 0;
	    	double crateWasteB = 0;
	    	...
	    	for(PackingResult packResult : packResults){
	    		...
	    		else if (packResult.getProductCode().equals(BIG_CRATE_C)) bigCrateC = packResult.getQty();
	    		else if (packResult.getProductCode().equals(SMALL_CRATE_C)) smallCrateC = packResult.getQty();
	    		else if (packResult.getProductCode().equals(CRATE_WASTE_A)) crateWasteA = packResult.getQty();
	    		else if (packResult.getProductCode().equals(CRATE_WASTE_B)) crateWasteB = packResult.getQty();
	    	}
	        switch(columnIndex){
	        	case 0 :
	        		return p.getId();
	    ...
	    public String getColumnName(int column) {
	        switch(column){
	            ...
	            case 10 :
	                return "Crate Besar C";
	            case 11 :
	                return "Crate Kecil C";
	            case 12 :
	                return "Cacat Finishing A";
	            case 13 :
	                return "Cacat Finishing B";
	            case 14 :
	                return "Status";
	            case 15 :
	                return "Action";
