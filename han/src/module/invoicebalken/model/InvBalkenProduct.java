...
public class InvBalkenProduct implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + inventoryBalkenId;
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		InvBalkenProduct other = (InvBalkenProduct) obj;
		if (deletedBy == null) {
		...
		if (id != other.id)
			return false;
		if (inventoryBalkenId != other.inventoryBalkenId)
			return false;
		if (idrPrice == null) {
