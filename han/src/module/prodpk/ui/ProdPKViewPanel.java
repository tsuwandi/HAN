...
public class ProdPKViewPanel extends JPanel implements Bridging {

	private static final long serialVersionUID = 1L;

	private static final Logger LOGGER = Logger.getLogger(ProdPKViewPanel.class);
	...
	public ProdPKViewPanel() {
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				MainPanel.changePanel("module.prodpk.ui.ProdPKEditPanel", prodPK);
			}
		});
