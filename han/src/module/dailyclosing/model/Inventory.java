...
public class Inventory implements Serializable {
	...
	public String toString() {
		return "Inventory [id=" + id + ", productCode=" + productCode + ", qty=" + qty + ", warehouse=" + warehouse
				+ ", stockDate=" + stockDate + ", inventoryLogId=" + inventoryLogId + ", inputDate=" + inputDate
	...
	public int hashCode() {
		...
		result = prime * result + inventoryLogId;
	...
	public boolean equals(Object obj) {
		...
		if (inputDate == null) {
			...
			return false;
		if (inventoryLogId != other.inventoryLogId)
			return false;
		if (productCode == null) {
