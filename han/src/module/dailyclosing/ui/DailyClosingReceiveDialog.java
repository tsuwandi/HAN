...
public class DailyClosingReceiveDialog extends JDialog {

	private static final long serialVersionUID = 1L;
	
	private static final Logger LOGGER = Logger.getLogger(DailyClosingReceiveDialog.class);
	...
	public DailyClosingReceiveDialog() {
		setModal(true);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (rdbtnMonitor.isSelected()) {
						...
						int rVal = c.showSaveDialog(DailyClosingReceiveDialog.this);
