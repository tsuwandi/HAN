...
public class PayBalkenProduct implements Serializable {

	private static final long serialVersionUID = 1L;

	private int id;
	private int paymentBalkenId;
	...
	public int getPaymentBalkenId() {
		return paymentBalkenId;
	}

	public void setPaymentBalkenId(int paymentBalkenId) {
		this.paymentBalkenId = paymentBalkenId;
	}
	...
	public int hashCode() {
		...
		result = prime * result + paymentBalkenId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PayBalkenProduct other = (PayBalkenProduct) obj;
		if (deletedBy == null) {
	...
	public String toString() {
		return "PayPrProduct [id=" + id + ", paymentBalkenId=" + paymentBalkenId
