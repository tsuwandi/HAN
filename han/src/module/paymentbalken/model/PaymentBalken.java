package module.paymentbalken.model;

import java.io.Serializable;
import java.math.BigDecimal;
import java.util.Date;

public class PaymentBalken implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((receivedCode == null) ? 0 : receivedCode.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PaymentBalken other = (PaymentBalken) obj;
		if (confirmCode == null) {
	...
	public String toString() {
		return "PaymentProdResult [id=" + id + ", receivedCode=" + receivedCode
				+ ", dueDate=" + dueDate + ", rate=" + rate
				+ ", paymentStatus=" + paymentStatus + ", subtotal=" + subtotal
				+ ", disc=" + disc + ", tax=" + tax + ", otherFee=" + otherFee
				+ ", total=" + total + ", status=" + status + ", confirmCode="
				+ confirmCode + ", confirmDate=" + confirmDate + ", inputDate="
				+ inputDate + ", inputBy=" + inputBy + ", editDate=" + editDate
				+ ", editedBy=" + editedBy + ", deletedDate=" + deletedDate
				+ ", deletedBy=" + deletedBy + "]";
	}
	...
	public int getInventoryBalkenId() {
		return inventoryBalkenId;
	}

	public void setInventoryBalkenId(int inventoryBalkenId) {
		this.inventoryBalkenId = inventoryBalkenId;
	}
