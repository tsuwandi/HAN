...
private static final long serialVersionUID = 1L;
	...
	public ProductDialog(PurchaseProdSuppCreatePanel ppsCreatePanel) {
	...
	public ProductDialog(PurchaseProdSuppEditPanel ppsEditPanel) {
	...
	public void load() {
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Integer productCategoryId = ppsCreatePanel.getProductCategoryId();
				doAdvancedSearch(productCategoryId);
			}
		});
	...
	public void doAdvancedSearch(Integer productCategoryId) {
		try {
			...
			products = ServiceFactory.getPurchaseProductSuppBL().getAllProductByAdvancedSearch(product);
	...
	public void doSave() {
		if(addProduct != null) {
			if(ppsCreatePanel != null) {
				ppsCreatePanel.txtProduct.setText(addProduct.getProductName());
				ppsCreatePanel.setProductCode(addProduct.getProductCode());
				ppsCreatePanel.txtUOM.setText(addProduct.getProductUom().getUom());
				ppsCreatePanel.setProductUomId(Integer.valueOf(addProduct.getProductUomId()));
			}
			if(ppsEditPanel != null) {
				ppsEditPanel.txtProduct.setText(addProduct.getProductName());
				ppsEditPanel.setProductCode(addProduct.getProductCode());
				ppsEditPanel.txtUOM.setText(addProduct.getProductUom().getUom());
				ppsEditPanel.setProductUomId(Integer.valueOf(addProduct.getProductUomId()));
			}
		}
		closeDialog();
	}
