...
public class PurchaseProdSuppViewPanel extends JPanel implements Bridging {
	...
	private static final Logger LOGGER = Logger
			.getLogger(PurchaseProdSuppViewPanel.class);
	...
	PurchaseProdSuppViewPanel pprViewPanel;
	...
	public PurchaseProdSuppViewPanel() {
		...
		btnPrint.setBounds(715, 690, 100, 25);
		panel.add(btnPrint);
		...
		btnDelete.setBounds(820, 690, 100, 25);
		panel.add(btnDelete);

		btnEdit = new JButton("Ubah");
		btnEdit.setBounds(925, 690, 100, 25);
		panel.add(btnEdit);
		...
		btnEdit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MainPanel.changePanel("module.purchaseprodsupp.ui.PurchaseProdSuppEditPanel", purchaseProductSupp);
			}
		});
	...
	protected void doDelete() {
		try {
			ServiceFactory.getPurchaseProductSuppBL().deleteAll(purchaseProductSupp);
	...
	public void addPOBarangPendukung() {
		...
		txtNote.setBackground(Color.LIGHT_GRAY);
		panel.add(txtNote);
...
//		makeCodeNumber(dcPurchaseDate.getDate());
		...
		dcDeliveryDate.setEnabled(false);
		...
		btnSearchSupplier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//showSupplierDialog(pprViewPanel);
			}
		});
		...
		btnSearchCostCenter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//showCostCenterDialog(pprViewPanel);
			}
		});
		btnSearchCostCenter.setEnabled(false);
	...
	public void addProductSupp() {
		...
		btnSearchProduct.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//showProductDialog(pprViewPanel);
			}
		});
		...
		btnInsertPPSProduct.setEnabled(false);
...
//			}
	...
	protected void showSupplierDialog(
			PurchaseProdSuppCreatePanel pprViewPanel) {
		SupplierDialog supplierDialog = new SupplierDialog(pprViewPanel);
	...
	protected void showCostCenterDialog(
			PurchaseProdSuppCreatePanel pprViewPanel) {
		CostCenterDialog costCenterDialog = new CostCenterDialog(pprViewPanel);
	...
	protected void showProductDialog(
			PurchaseProdSuppCreatePanel pprViewPanel) {
		ProductDialog productDialog = new ProductDialog(pprViewPanel);
	...
	protected void showEditPPSProductDialog(PPSProduct pprProduct,
			PurchaseProdSuppCreatePanel pprViewPanel, Integer index) {
