...
public class PopUpViewProdPKResult extends JDialog{
	Logger log = LogManager.getLogger(PopUpViewProdPKResult.class.getName());
	...
	public PopUpViewProdPKResult(JPanel parent){
