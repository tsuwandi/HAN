...
public class ProductSupportingGoodEditPanel extends JPanel implements Bridging {

	private static final long serialVersionUID = 1L;

	private static final Logger LOGGER = Logger.getLogger(ProductSupportingGoodEditPanel.class);
	...
	public ProductSupportingGoodEditPanel() {
...
//		}
	...
	public void doSave() {
		...
		// atribute product
		productSupp.setLength(
				"".equals(txtLength.getText()) ? null : BigDecimal.valueOf(Double.valueOf(txtLength.getText())));
		productSupp.setWidth(
				"".equals(txtWidth.getText()) ? null : BigDecimal.valueOf(Double.valueOf(txtWidth.getText())));
		productSupp.setThickness(
				"".equals(txtThickness.getText()) ? null : BigDecimal.valueOf(Double.valueOf(txtThickness.getText())));
		productSupp.setWeightNet(
				"".equals(txtWeightNet.getText()) ? null : BigDecimal.valueOf(Double.valueOf(txtWeightNet.getText())));
		productSupp.setWeightGross("".equals(txtWeightGross.getText()) ? null
				: BigDecimal.valueOf(Double.valueOf(txtWeightGross.getText())));
		...
		productSupp.setMaxDisc("".equals(txtMaximumDiscount.getText()) ? null
				: BigDecimal.valueOf(Double.valueOf(txtMaximumDiscount.getText())));
		productSupp.setTaxId(null);

		try {
			ServiceFactory.getProductSupportingGoodBL().update(productSupp);
	...
	public void makeCodeNumber(String productCategory) {
		...
		txtProductCode
				.setText(new StringBuilder().append(constantProductCategory).append("-").append(ordinal).toString());
	}
