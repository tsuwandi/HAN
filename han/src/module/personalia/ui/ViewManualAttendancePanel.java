...
public class ViewManualAttendancePanel extends JPanel {
	...
	public ViewManualAttendancePanel() {
		setSize(1024, 630);
		setLayout(null);
		...
		JButton saveBtn = new JButton("Cetak");
		...
		attendanceDateField.setEnabled(false);
		attendanceDateField.setEditable(false);
