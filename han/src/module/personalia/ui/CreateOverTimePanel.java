...
public class CreateOverTimePanel extends JPanel {
	...
	public CreateOverTimePanel() {
		setSize(1024, 630);
		setLayout(null);
		
		JLabel breadCrumbLbl = new JLabel("Personalia > Lembur > Pendaftaran Baru");
		breadCrumbLbl.setFont(new Font("Tahoma", Font.BOLD, 12));
		breadCrumbLbl.setBounds(50, 10, 290, 25);
		add(breadCrumbLbl);
		
		JLabel lblHeader = new JLabel("PENDAFTARAN LEMBUR");
		...
		startTimeField.setBounds(140, 329, 200, 30);
		add(startTimeField);
		// jam selesai
		...
		endTimeField.setBounds(140, 370, 200, 30);
		add(endTimeField);
		// referensi
		...
		descField.setBounds(140, 452, 200, 30);
		add(descField);
