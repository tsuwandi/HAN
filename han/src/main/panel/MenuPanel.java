...
public class MenuPanel extends JPanel {
	...
	public MenuPanel() {
		...
		menu.addNewLeafTo("General", "Produk Barang Pendukung", "Produk Barang Pendukung", "module.productsupportinggood.ui.ProductSupportingGoodListPanel");
		...
		menu.addNewLeafTo("Purchasing", "Pembelian Barang Pendukung", "Pembelian Barang Pendukung", "module.purchaseprodsupp.ui.PurchaseProdSuppListPanel");
		menu.addNewLeafTo("Purchasing", "Penerimaan Barang Pendukung", "Penerimaan Barang Pendukung", "module.receiveprodsupp.ui.ReceiveProdSuppListPanel");
		menu.calculateAvaiableSpace();
