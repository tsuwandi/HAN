...
public final class AccordionMenu extends JPanel {
	...
	/**
	 * Default basic constructor. Creates tree map of menu. And prepares layout
	 * and events.
	 */
	 ...
	 * The stucture for example is like: <br>
	 * <br>
	 ...
	 * <br>
	 * <br>
	 * Each element is a couple <code>itemName,itemTitle</code> like (Menu
	 * One,menu1).<br>
	 * <code>itemName</code> is used as handle to menu item.<br>
	 * The ":" regex is used to separate Menu Root Item to its Leafs. The ","
	 * separates leafs. And "!" regex is used to separate each Menu Root from
	 * others.
	 * 
	 * @param menuDescriptor
	 *            String representing structure of menu.
	 */
	...
	/**
	 *
	 * @return {@link MouseAdapter} object with implementation of events of
	 *         mouse on Leaf Menu Items.
	 */
	...
	/**
	 * Begin animation of Closing/Opening of new menu branch. It divides the
	 * <code>branchAvaiableSpace</code> in two parts <code>showingSize</code>
	 * and <code>hidingSize</code>, the first one grow up and the second one
	 * goes to zero with a certain time step. Pixel step is fixed to 30 but is
	 * not a charge.
	 */
	...
	/**
	 * The core dispplay engine is in this function. The algorithm is very
	 * simple: each Menu Root Item is displayed with 100% width and one behind
	 * others, with fixed menuSize height. In case that Menu is selected, it
	 * starts to displays the menuBranch of selected menu and it starts to hide
	 * the menuBranch of previous selected menu. This function ignores the
	 * animation function; it just displays, with some parameters, the current
	 * and previous selected menues. So the animation function changes
	 * parameters at runtime to give an animation effect.
	 * 
	 * @param g
	...
	/**
	 *
	 * @return List of {@link AccordionLeafItem}, handles to Menu Leaf Items of
	 *         all menu.
	 */
	...
	/**
	 * Calculates some parameters. Usally called after a resize event because it
	 * calculate some parameters depending of Size of this component.
	 */
	 ...
	 *
	 * @param menuName
	 *            Father menu of new leaf.
	 * @param leafTitle
	 *            Displayed title.
	 * @param leafName
	 *            Binding name.
	 */
	public void addNewLeafTo(String menuName, String leafName, String leafTitle, String module) {
		for (AccordionRootItem menu : getMenus()) {
			if (menu.getName().equals(menuName)) {
	 ...
	 * 
	 * @param normal
	 *            Normal {@link ImageIcon}.
	 * @param selected
	 *            Selected {@link ImageIcon}.
	 */
	...
	/**
	 * Sets icons to all Menu Leaf Items. Accepts null value if you want to
	 * change only one icon type.
	 * 
	 * @param normal
	 *            Normal {@link ImageIcon}.
	 * @param selected
	...
	/**
	 * Sets icons to Menu Leaf Items of selected Menu Root Item if any. Accepts
	 * null value if you want to change only one icon type.
	 * 
	 * @param menuName
	 *            Target Menu Root Item.
	 * @param normal
	 *            Normal {@link ImageIcon}.
	 * @param selected
	 *            Selected {@link ImageIcon}.
	 ...
	 * 
	 * @param align
	 *            Alignment value. es. use <code>AccordionItem.CENTER</code>.
	 */
	 ...
	 * 
	 * @param Alignment
	 *            value. es. use <code>AccordionItem.CENTER</code>.
	 */
	...
	/**
	 * Sets Value of height size of Root Menu Items. Tests show that 30 is
	 * minimum for a better view
	 * 
	 * @param menusSize
	 */
